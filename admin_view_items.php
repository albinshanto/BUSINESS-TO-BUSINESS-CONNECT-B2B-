...
$sql = "
    SELECT orderc.*, item.iname, item.file, item.amt
    FROM orderc 
...
<h3 class="mb-4">Items in Order #<?php echo $oid; ?></h3>
...
<tr>
  <td>
      <img src="<?php echo $r['file']; ?>" width="100" height="100">
  </td>
  <td><?php echo $r['iname']; ?></td>
  <td><?php echo $r['qty']; ?></td>
  <td><?php echo $r['qty'] * $r['amt']; ?></td>
</tr>
<?php } ?>
</tbody>
</table>
