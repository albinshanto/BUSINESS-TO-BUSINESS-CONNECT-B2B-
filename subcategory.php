...
<h2 class="page-title">Subcategory Management</h2>

<!-- SUBCATEGORY ADD FORM -->
<form action="subcategoryaction.php" class="form-contact contact_form" novalidate="novalidate">
  <div class="form-group">
    <input type="text" name="t1" class="form-control" placeholder="Enter Subcategory Name"
  ...
  <div class="form-group text-center">
    <button type="submit" class="button button--active button-contactForm">Add Subcategory</button>
  </div>
</form>
...
<table class="styled-table">
  ...
  <tbody>
    ...
    ?>
    <tr>
      <td><?php echo $row['scatid']; ?></td>
      <td><?php echo $row['sname']; ?></td>
      <td><?php echo $row['catid']; ?></td>
      <td><a href="deletescat.php?id=<?php echo $row['scatid']; ?>" class="btn-delete">Delete</a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
