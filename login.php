  ...
  <section class="section-margin--small">
    <div class="container">
      ...
      <div class="row">
        ...
        <!-- LOGIN FORM (Styled like Contact / Wholesaler / Retailer Forms) -->
<form action="loginaction.php" class="form-contact contact_form" id="loginForm" novalidate="novalidate">
  <div class="row justify-content-center">
    <div class="col-lg-6">
      <div class="form-group">
        <input type="text" name="uname" class="form-control" placeholder="Email (Username)"
